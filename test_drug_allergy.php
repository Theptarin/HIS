...
$url = 'http://10.1.88.8/HIS/index.php/DrugAllergyRpcS';
//$url = 'http://61cd1fe0.ngrok.io/HIS/index.php/DrugAllergyRpcS';
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>ทะเบียนผู้ป่วยที่แพ้ยา(JsonRPC)</title>
        <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css">
    </head>
    <body>
        <div class="container">
            <div class="page-header">
                <h1>ทะเบียนผู้ป่วยที่แพ้ยา HIMs(JsonRPC)</h1>
            </div>
            <?php
